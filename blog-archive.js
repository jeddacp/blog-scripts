...
main.querySelector(".tags")?.closest("small")?.remove();
...
const parseDatetime = (dt) => {
  ...
  // en-CA locale formats as YYYY-MM-DD, easy to split back apart
  const [y, mo, d] = pacificDateFormatter.format(raw).split("-");
